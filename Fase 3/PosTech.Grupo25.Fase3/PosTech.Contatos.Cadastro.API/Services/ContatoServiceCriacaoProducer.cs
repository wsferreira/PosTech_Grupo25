...
{
    public class ContatoServiceCriacaoProducer : IContatoServiceCriacaoProducer
    {
        private readonly IConfiguration _configuration;
        private readonly IRegiaoRepository _regiaoRepository;

        public ContatoServiceCriacaoProducer(IConfiguration configuration, IRegiaoRepository regiaoRepository)
        {
