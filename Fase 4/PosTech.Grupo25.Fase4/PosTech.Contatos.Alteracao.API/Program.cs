...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    ...
    options.EnableSensitiveDataLogging(true); // ADD Antonio Jos� Lima Jr -> 18/05/2024

}, ServiceLifetime.Scoped);

builder.Services.AddScoped<IContatoServiceAlteracaoProducer, ContatoServiceAlteracaoProducer>();
